...
const buttonVariants = cva(
  "inline-flex items-center justify-center whitespace-nowrap rounded-md text-sm font-medium ring-offset-background transition-colors outline-none disabled:pointer-events-none disabled:opacity-50",
  {
    variants: {
      variant: {
        default:
          "bg-main-purple hover:bg-main-purple-hover text-primary-foreground dark:text-white",
        destructive: "bg-destructive text-white hover:bg-destructive/90",
        outline:
          "border border-input bg-background hover:bg-accent hover:text-accent-foreground",
        secondary:
          "bg-main-purple/10 dark:bg-white text-main-purple hover:bg-main-purple/25 dark:hover:bg-white/80 dark:text-main-purple",
        ghost:

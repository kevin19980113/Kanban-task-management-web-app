...
export default function BoarderList({
  ...
  return (
    <div>
      ...
      <div className="w-full flex flex-col items-start text-left text-medium-grey font-medium pr-10">
        {boards.map((board, index) => (
          ...
          >
            <svg
              ...
              className={`size-4 fill-main-purple group-hover:fill-main-purple ${
